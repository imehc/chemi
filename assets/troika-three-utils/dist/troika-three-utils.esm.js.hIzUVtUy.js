...
${c}
`,t=t.replace(/\b(position|normal|uv)\b/g,(a,v,O,T)=>/\battribute\s+vec[23]\s+$/.test(T.substr(0,O))?v:`troika_${v}_${r}`),n.map&&n.map.channel>0||(t=t.replace(/\bMAP_UV\b/g,`troika_uv_${r}`))),t=C(t,r,u,c,_),i=C(i,r,e,f,l),{vertexShader:t,fragmentShader:i}}function C(n,t,i,o,r){return(o||r||i)&&(n=n.replace(R,`
${i}
...
void main() {
  ...
  troikaOrigMain${t}();
  ${r}
}`),n}function I(n,t){return n==="uniforms"?void 0:typeof t=="function"?t.toString():t}let j=0;const w=new Map;function k(n){const t=JSON.stringify(n,I);let i=w.get(t);return i==null&&w.set(t,i=++j),i}export{M as c,R as v};
//# sourceMappingURL=troika-three-utils.esm.js.hIzUVtUy.js.map
