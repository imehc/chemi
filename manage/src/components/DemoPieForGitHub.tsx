...
import { Pie, measureTextWidth, G2, PieConfig } from '@ant-design/plots';

export const DemoPieForGitHub = () => {
  ...
  G2.registerInteraction('custom-interaction', {
    start: [
      {
        trigger: 'customClick',
  ...
  return <Pie {...(config as unknown as PieConfig)} ref={(e:any) => {
    setTimeout(() => {
      e.getChart().chart.emit('customClick',
        {
          type: '1',
          data: {
            data: {
