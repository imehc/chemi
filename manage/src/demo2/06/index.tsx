...
export const Demoo006 = () => {
  ...
  return (
    <Canvas camera={{ position: [1, 2, 3] }}>
      ...
      <mesh
        position-x={redBall.positionX}
        rotation-x={redBall.rotationX}
        scale={redBall.scaleX}
      >
        <icosahedronGeometry args={[1, 1]} />
        <meshStandardMaterial color={'red'} flatShading />
        <axesHelper args={[5]} />
        <mesh
          position-x={blueBall.positionX}
          rotation-x={blueBall.rotationX}
          scale={blueBall.scaleX}
        >
          <icosahedronGeometry args={[1, 1]} />
          <meshStandardMaterial color={'blue'} flatShading />
          <axesHelper args={[5]} />
          <mesh
            position-x={greenBall.positionX}
            rotation-x={greenBall.rotationX}
            scale={greenBall.scaleX}
          >
            <icosahedronGeometry args={[1, 1]} />
